let nav = 0; /* keep track on which month were on */
...
function load() {
    ...
    calendar.innerHTML = ''; /* Wipe day squares out before creating new ones */
    ...
    for (let i = 1; i  <= paddingDays + daysInMonth; i++) {
        ...
        if(i > paddingDays) 
        {
            ...
            const eventForDay = events.find(e => e.date === dayString);// check if theres an event for the day we're on
